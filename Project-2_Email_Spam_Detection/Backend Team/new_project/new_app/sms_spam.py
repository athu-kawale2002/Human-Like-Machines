...
def sms_spam_detection(string):
    ...
    df=pd.read_csv('https://raw.githubusercontent.com/athu-kawale2002/Human-Like-Machines/master/Project-2_Email_Spam_Detection/ML%20Team/Spam%20CSV\'s/sms_spam.csv')
